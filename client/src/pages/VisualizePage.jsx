...
import {
  Upload, FileJson, TrendingUp, AlertTriangle, CheckCircle, Download,
  Sparkles, Brain, Mic, Shield, ChevronRight, Camera, Copy, Check,
  Activity, BarChart3, PieChart as PieChartIcon, Radar as RadarIcon,
...
const VisualizePage = () => {
  ...
  const exportAsImage = async () => {
    ...
    try {
      ...
      link.download = `fakeout-insight-${jsonData?.timestamp || Date.now()}.png`;
      ...
      <AnimatePresence mode="wait">
        {!jsonData ? (
          <motion.div
            ...
            {...getRootProps()}
            className={`glass-card rounded-3xl p-12 text-center cursor-pointer transition-all border-2 ${
          ...
          >
            ...
            >
              <FileJson className="w-20 h-20 mx-auto mb-5 text-amber-500" />
            </motion.div>
            <p className="text-xl font-medium">Drop your JSON report here</p>
          ...
          >
            ...
            <div className="flex flex-wrap justify-between items-center gap-3 mb-6">
              ...
              <div className="flex gap-3">
                <button
                  onClick={copyRawData}
                  className="flex items-center gap-2 px-4 py-2 rounded-xl glass-card text-sm hover:bg-white/10 transition"
                >
            ...
            <div ref={dashboardRef} className="space-y-8 pb-8">
              ...
              <motion.div
                initial={{ scale: 0.98 }}
                animate={{ scale: 1 }}
                className={`glass-card rounded-3xl p-6 border-l-8 overflow-hidden relative`}
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
                  <div className="flex items-center gap-5">
                    <div className={`w-20 h-20 rounded-2xl bg-gradient-to-br ${config.bgGradient} flex items-center justify-center shadow-lg`}>
                      <config.icon className="w-10 h-10 text-white" />
                    </div>
                    <div>
                      <p className="text-sm text-gray-400 uppercase tracking-wide">Analysis Verdict</p>
                      <h2 className="text-4xl font-bold" style={{ color: config.color }}>{config.label}</h2>
                  ...
                  <div className="text-right">
                    ...
                    <div className="flex items-baseline gap-1">
                      <span className="text-6xl font-bold">{jsonData.confidence}</span>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {additionalMetrics.map((metric, idx) => (
                  ...
                  >
                    <metric.icon className="w-5 h-5 mx-auto mb-2 text-amber-500" />
                ...
                {modelData.map((model, idx) => (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <span className="text-xs text-gray-400">{model.fullName}</span>
                    </div>
                    <div className="flex items-end justify-between mt-2">
                      <div>
                        <p className="text-4xl font-bold">{model.confidence}%</p>
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                >
                  <h3 className="font-semibold mb-4 flex items-center gap-2"><PieChartIcon className="w-5 h-5 text-amber-500" /> Confidence Breakdown</h3>
                ...
                <motion.div
                  ...
                  className="glass-card rounded-2xl p-5"
                >
                  <h3 className="font-semibold mb-4 flex items-center gap-2"><RadarIcon className="w-5 h-5 text-amber-500" /> Model Capabilities</h3>
                  <ResponsiveContainer width="100%" height={260}>
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-2">Why this verdict?</h3>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">{jsonData.explanation}</p>
              ...
              <details className="glass-card rounded-2xl p-5 border border-white/10">
                <summary className="cursor-pointer font-medium flex items-center gap-2">
                  <FileJson className="w-4 h-4" /> View Raw JSON Data
                </summary>
                <pre className="mt-4 bg-black/30 p-4 rounded-xl overflow-auto text-xs font-mono max-h-96">
